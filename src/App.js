                ...
                {SideList.map((item) => (
                    <nav className="sidebar">
                        <div className="hidden">
                            ...
                            {/* Account_conneted 연결 */}
                            <div className="account_conneted">
                                {/* dropdown 레벨 */}
                                ...
                                <div className="menu">
                                    ...
                                    <NavLink to="/exchange" className="item" href="/nl/exchange">
                                        <div className="icon">
                                            <div className="flex">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                    ...
                                    <NavLink to="/pool" className="item" href="/nl/invest">
                                        <div className="icon">
                                            <div className="flex">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        ...
                                        <span>{item.Pool}</span></NavLink>
                                    <NavLink to="/save" className="item" href="/nl/save">
                                        <div className="icon">
                                            <div className="flex">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        ...
                                        <span>{item.Save}</span></NavLink>
                                    <NavLink to="/address" className="item" href="/nl/watchlist">
                                        <div className="icon">
                                            <div className="flex">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                    ...
                                    {/* toggle Menu More Side */}
                                    <div className="sidebar" className="item" onClick={sideMenu}>
                                            <div className="icon">
                                                <div className="flex">
                                ...
                                <div className="box">
                                  <div className="language">
                                      <div className="pop">
                                          <img src="https://zapper.fi/images/currencies/EUR.svg" />
                                          <div className="title">
                                              <span>EUR</span>
                                    ...
                                    <div className="mod">
                                        <div className="style">
                                           <div className="switch">
                                               ...
                                               <div className="button">
                                                   <div className="icon">
                                                       <img src="https://zapper.fi/images/other/sun.svg" alt="button" />
                                                   </div>
                                               </div>
                                           </div>
